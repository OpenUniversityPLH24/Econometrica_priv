...
//        System.out.println("SaveActionButton with Dataset ID = " + (countryDatasetGDP.getDatasetId()));
    ...
    private void PlotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PlotActionPerformed
        ...
        countryDatasetGDP = new CountryDataset();
        em = DBManager.getEm();
        
        em.persist(country);   
        em.persist(countryData);
        em.persist(countryDatasetGDP);
        
        JFreeChat jfc = new JFreeChat(country, countryData, countryDatasetGDP, false);
        jfc.setVisible(true);
        jfc.pack();
//        thisFrame = this;
...
//            System.out.println("WindowEvent = " + we + " in windowOpened");
//            //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//            }
//
//            @Override
//            public void windowClosing(WindowEvent we) {
//            System.out.println("WindowEvent = " + we + " in windowClosing");    
//            //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//            }
//
//            @Override
//            public void windowIconified(WindowEvent we) {
//            System.out.println("WindowEvent = " + we + " in windowIconified");     
//            //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//            }
//
//            @Override
...
//            System.out.println("WindowEvent = " + we + " in windowActivated");
//            //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//            }
//
//            @Override
//            public void windowDeactivated(WindowEvent we) {
//            System.out.println("WindowEvent = " + we + " in windowDeactivated");
//            //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//            }
//        }
//        );
    ...
    private void DeleteAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteAllActionPerformed
        // TODO add your handling code here:
     JFreeChart2 jfc = new JFreeChart2("Annotation2AxisChart");
        jfc.setVisible(true);
        jfc.pack();
